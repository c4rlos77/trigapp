...
# st.set_page_config(page_title="Presentación Personal", layout="wide")
...
# Columna 2: Texto de introducción
with col2:
    st.markdown("""
...
# Marco 1: Intereses y afinidades
...
# Marco 2: Reflexión sobre Programación I
st.markdown("<hr>", unsafe_allow_html=True)
with st.container():
